 ...
 * @notice Stake-weighted random juror drawing, staking lifecycle, slashing & rewards.
 * @dev Called by KlerosCore via the ISortitionModuleLink forward declaration.
 */
interface ISortitionModule {
    ...
    event UnstakeExecuted(address indexed juror, uint96 indexed courtID, uint256 amount);
    ...
    function draw(uint256 _disputeID, uint96 _courtID, uint256 _count, uint256 _nonce)
